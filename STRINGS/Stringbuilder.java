class stringbuilder {
    public static void main(String args[]) {
        ...
        for (char ch = 'a'; ch <= 'z'; ch++) { // in this loop, from a to z all chars append one by one in the string
            ...
            // .append fxn - apni string ke peeche jodne ke liye; mtlb stringbuilder me jo
            // string hai usme apne characters ko jodte aayenge
        }
...
// TC = O(26)
// TC = O(n^2) n->string length //this happens when we take a string and instead
// of append we do +=, then this happens