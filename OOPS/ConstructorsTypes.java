public class ConstructorsTypes {
    public static void main(String args[]) {
        ...
        // Student s4 = new Student("Aryan", 567);// in this, no constructor is called, because there doesn't exist a constructor in which 1st parameter is a string and 2nd is int
        ...
        // But for some reason this, scopy student forgets his password, so we are creating new object for this
        Student scopy2 = new Student(scopy); //We want that all the properties of scopy got copy into scopy2
        scopy2.Password = "abcd"; // We decide to inly copy name and roll properties and gives a new passrowrd to scopy2
        scopy.marks[2] = 100;
        for(int i = 0; i < 3; i++) {
...
class Student {
    ...
    // Student (Student scopy) { //In this, we pass Student scopy as a parameter. Means, khud hi ka obj khud constructor me as a paramter aa rha hai
    //     marks = new int[3];
    //     this.name = scopy.name;
    //     this.roll = scopy.roll;
    //     this.marks = scopy.marks; //here, only reference got copied not the array; marks of scopy2 only points at the array that is already created, and not create a whole new array
        // So, any change made in the scopy, will also get reflected in the marks of scopy2
    //}
